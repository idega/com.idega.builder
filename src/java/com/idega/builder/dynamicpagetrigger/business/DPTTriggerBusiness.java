...
public interface DPTTriggerBusiness extends com.idega.business.IBOService
{
 ...
 public int createTriggerRule(com.idega.core.component.data.ICObject p0,int p1,int[] p2,com.idega.core.builder.data.ICPage[] p3)throws java.sql.SQLException, java.rmi.RemoteException;
