...
{
 public boolean addObjectInstancToSubPages(int p0, IWUserContext iwuc)throws java.sql.SQLException, java.rmi.RemoteException;
 public boolean addObjectInstancToSubPages(com.idega.core.component.data.ICObjectInstance p0, IWUserContext iwuc) throws java.rmi.RemoteException;
 ...
 public com.idega.builder.dynamicpagetrigger.data.PageLink createPageLink(com.idega.presentation.IWContext p0,com.idega.builder.dynamicpagetrigger.data.PageTriggerInfo p1,java.lang.String p2,java.lang.String p3,java.lang.String p4,java.lang.Integer p5,java.lang.Integer p6,java.lang.Integer p7)throws Exception, java.rmi.RemoteException;
