...
public class IBJspPageBMPBean extends com.idega.data.GenericEntity implements com.idega.builder.data.IBJspPage {
  ...
  public IBJspPageBMPBean(int id) throws SQLException {
